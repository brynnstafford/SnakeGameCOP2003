...
* game object with position, size, and velocities (Lab 4)
*******************************************************************************/
#include "block.h"  // implementing class object "block.h"
...
/******************************************************************************
tests if a block overlaps this block
parameters:
...
{   // if any of these conditions are true then the blocks do not overlap
...
/******************************************************************************
determine if this block is moving
parameters:
returns:
...
{
	// create a new block as copy of other block
